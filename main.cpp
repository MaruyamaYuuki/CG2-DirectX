...
#pragma endregion
	...
	// 頂点リソースを作る
	ID3D12Resource* vertexResource = CreateBuffurResource(device, sizeof(VertexData) * 6);
	...
	*wvpData = MakeIdentity4x4();
	...
	// 左下2
	vertexData[3].position = { -0.5,-0.5,0.5,1.0, };
	...
	ID3D12Resource* transformationMatrixResourceSprite = CreateBuffurResource(device, sizeof(Matrix4x4));
	// データを書き込む
